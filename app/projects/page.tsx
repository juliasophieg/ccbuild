    ...
    <>
      ...
      <div className="flex w-screen flex-col items-center px-4 ">
        <div className="flex w-full max-w-6xl flex-col py-7">
          ...
          <NextLink href={`/projects/create`} className="self-end mb-4">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            {projects.reverse().map((project) => (
              <Link
                ...
                key={project._id}
                className="flex aspect-square flex-col justify-between rounded-lg bg-white p-6 text-custom-blue shadow-lg hover:scale-105"
              >
                <div className="my-2">
